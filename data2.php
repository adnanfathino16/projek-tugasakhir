<?php 
  ...
  // baca informasi tegangan untuk 5 data terakhir - sumbu y di grafik
  
  $arus = mysqli_query($konek, "SELECT arus from iot_tb WHERE ID>='$ID_awal' and ID<='$ID_akhir' ORDER BY ID ASC ");
  // baca informasi arus untuk 5 data terakhir - sumbu y di grafik
    ...
    <div class="panel-body">
       ...
       var data = {
           ...
           
             {
       	   		label : "arus",
              fill : true,
              backgroundColor : "rgba(239, 82, 93, .2)",
              borderColor : "rgba(239, 82, 93, 0.5)",
              pointRadius : 5,
       	   		data : [
       	   		<?php 
